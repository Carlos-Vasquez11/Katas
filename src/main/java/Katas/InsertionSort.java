...
public class InsertionSort {
  ...
  public static void changeValues(int[] array, int firstPosition, int secondPosition){
    int aux;
  ...
  public static void insertionSort(int[] array){
    ...
    for (int marker = 1; marker < array.length; marker++ ){
      for (int element = marker ; element > 0; element--){
        if(array[element - 1] > array[element]){
          changeValues(array,element - 1,element);
        }
      }
    }
  ...
  public static void main(String args[]) {
    ...
    int[] miArray = {-796, 3229, -5164, -362, 4408, 8965, -6068, 9329, -3034, -443, -6693, 9497, 2615, -5966, -9065, -1160, 6148, 5517, 1123, -8887
